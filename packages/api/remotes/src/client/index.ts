...
import voiceContextRemote from '@deepseek-ai/dsh-voice-context/remote'
...
export type {} from '@deepseek-ai/dsh-voice-context/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, voiceContextRemote,
    ]) {

...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-voice-context': { kind: 'indirect', reason: 'Browser-side transcription only reaches model context after the user submits the resulting composer draft.' },
  ...
  'packages/voice/voice-context': { kind: 'none', reason: 'Speech transcription produces human draft input and never assembles or sends a model request.' },

...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TranscribeRequest: 'voice transcription wire input is owned by packages/voice/voice-context/README.md',
  TranscribeResult: 'voice transcription wire output is owned by packages/voice/voice-context/README.md',
